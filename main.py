...
def main():
    ...
    st.sidebar.title("Are your mushrooms edible or poisonous? Find out Now.")
    st.sidebar.markdown("Train your Own Model using Classification Techniques mentioned below:")
